...
define('DB_NAME', 'register');
		...
		$email = mysqli_real_escape_string($conn, $_POST['email']);
	    mysqli_query($conn,"UPDATE users SET firstname = '$firstname',   lastname = '$lastname',   otchestvo = '$otchestvo',   phone = '$phone',   email = '$email',groups = '$group', date = '$date' WHERE id = $id");
		header('location: https://it-sfera.uz/account/overview.php');
	}
?>
												...
												<div class="row mb-6">
													...
													<div class="col-lg-8">
														<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
															<div class="image-input-wrapper w-125px h-125px" style="background-image: url(assets/media/avatars/<?php echo $id?>/1.jpg)"></div>
