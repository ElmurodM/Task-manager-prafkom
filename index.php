	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
		<div class="d-flex flex-column flex-root">
            ...
            ?>
                ...
                $napr = $_SESSION['nap'];
                $sql = "SELECT * FROM tbl_task WHERE list_id = '$napr' and sost = 'bez'";
                $res = mysqli_query($conn, $sql);
                if($res==true)
                {
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
											...
											<div class="d-flex justify-content-between">
												<a href="https://it-sfera.uz/functions/get-task.php?task_id=<?php echo $task_id; ?>&email=<?php echo $_SESSION['email']?>" class="btn btn-danger btn-sm" >Взять задачу</a>
											</div>
										</div>
