					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						<div class="container-fluid" id="index">
							<div class="d-flex justify-content-between align-items-center mb-7">
								<h1>Все задачи</h1>
								<a class="btn btn-success py-2" href="https://it-sfera.uz/Profkom/moderators/taskmanager-main/functions/manage-list.php" >Управление направление</a>
								<a class="btn btn-success py-2" href="https://it-sfera.uz/Profkom/moderators/taskmanager-main/functions/index.php" >Управление задание</a>
								</div>
							<div class="row">
								<div class="col-4">
									<div>
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
											...
											<div class="d-flex justify-content-between">
												<a href="https://it-sfera.uz/Profkom/moderators/taskmanager-main/functions/update-task.php?task_id=<?php echo $task_id; ?>" class="btn btn-primary btn-sm me-3" >Изменить задачу</a>
												<a href="https://it-sfera.uz/Profkom/moderators/taskmanager-main/functions/delete-task.php?task_id=<?php echo $task_id; ?>" class="btn btn-danger btn-sm" >Удалить задачу</a>
											</div>
										</div>
