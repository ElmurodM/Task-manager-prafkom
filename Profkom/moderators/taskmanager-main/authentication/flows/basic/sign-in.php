					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<form method = "post" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="authentication/flows/basic/sign-in.php">
							<div class="text-center mb-10">
								...
								<div class="text-gray-400 fw-bold fs-4">Новый пользователь?
								<a href="authentication/flows/basic/sign-up.php" class="link-primary fw-bolder">Создай аккаунт</a></div>
