	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
		<div class="d-flex flex-column flex-root">
                    ...
                    if($count_rows>0)
                    {
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                            	...
                            	<div class="menu-item">
                            	    <a  class="menu-link" href="https://it-sfera.uz/Profkom/moderators/moderators/taskmanager-main/list-task.php?list_id=<?php echo $list_id; ?>">
            ...
            ?>
								...
								<button class="btn btn-success py-2"><a style = "color:white"href="add-task.php">Добавить задачу</a></button>
							</div>
							<div class="row">
								<div class="col-4">
									<div>
                ...
                if($res==true)
                {
                    ...
                    if($count_rows>0)
                    {
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                            										<div class="card-body mt-5 p-9 bg-white">
											<div class="fs-2hx fw-bolder"><?php echo $task_name; ?></div>
											<div class="fs-4 fw-bold text-gray-400 mb-4"><?php echo $desc; ?></div>
											<small>от <span><?php echo $priority; ?></span> до <span><?php echo $deadline; ?></span></small>
											<div class="d-flex justify-content-between">
												<a href="https://it-sfera.uz/Profkom/moderators/moderators/taskmanager-main/functions/update-task.php?task_id=<?php echo $task_id; ?>" class="btn btn-primary btn-sm me-3" >Изменить задачу</a>
												<a href="https://it-sfera.uz/Profkom/moderators/moderators/taskmanager-main/functions/delete-task.php?task_id=<?php echo $task_id; ?>" class="btn btn-danger btn-sm" >Удалить задачу</a>
											</div>
										</div>
