												...
												<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
													<div class="d-flex flex-column">
														<div class="d-flex align-items-center mb-2">
															<a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1"><?php echo $first?> <?php echo $last?> <?php echo $otchestvo?></a>
														</div>
													</div>
												</div>
												<h6>Направления:</h6>
												<ul class="list-unstyled custom-list">
													<li><a href=""><?php echo $napr?></a></li>
												</ul>
											</div>
										</div>
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									<div class="card-header cursor-pointer">
										<div class="card-title m-0">
											<h3 class="fw-bolder m-0">Информация</h3>
										</div>
										<a href="account/settings.php" class="btn btn-primary align-self-center">Изменить</a>
									</div>
									<div class="card-body p-9">
										<div class="row mb-7">
											<label class="col-lg-4 fw-bold text-muted">Полное имя</label>
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><?php echo $first?> <?php echo $last?> <?php echo $otchestvo?></span>
											</div>
										</div>
										<div class="row mb-7">
											<label class="col-lg-4 fw-bold text-muted">Номер телефона</label>
											<div class="col-lg-8 d-flex align-items-center">
												<span class="fw-bolder fs-6 text-gray-800 me-2"><?php echo $phone?></span>
											</div>
										</div>
										<div class="row mb-7">
											<label class="col-lg-4 fw-bold text-muted">Email</label>
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><a href=""><?php echo $ema?></a></span>
											</div>
										</div>
										<div class="row mb-7">
											<label class="col-lg-4 fw-bold text-muted">Группа</label>
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><?php echo $group?></span>
											</div>
										</div>
										<div class="row mb-7">
											<label class="col-lg-4 fw-bold text-muted">Дата рождения</label>
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><?php echo $birth?></span>
											</div>
										</div>
									</div>
								</div>
