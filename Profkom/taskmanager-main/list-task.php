	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
		<div class="d-flex flex-column flex-root">
                    ...
                    if($count_rows>0)
                    {
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                            	...
                            	<div class="menu-item">
                            	    <a  class="menu-link" href="https://it-sfera.uz/Profkom/taskmanager-main/list-task.php?list_id=<?php echo $list_id; ?>">
            ...
            ?>
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-5">
													<a href="index.php?logout='1'" class="menu-link px-5">выйти</a>
												</div>
											</div>
										</div>
									</div>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						<div class="container-fluid" id="index">
							<div class="d-flex justify-content-between align-items-center mb-7">
								<h1>Все задачи</h1>
								<a class="btn btn-success py-2" href="https://it-sfera.uz/Profkom/taskmanager-main/functions/manage-list.php" >Управление направление</a>
								<a class="btn btn-success py-2" href="https://it-sfera.uz/Profkom/taskmanager-main/functions/index.php" >Управление задание</a>
								</div>
							<div class="row">
								<div class="col-4">
									<div>
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
											...
											<div class="d-flex justify-content-between">
												<a href="https://it-sfera.uz/Profkom/taskmanager-main/functions/update-task.php?task_id=<?php echo $task_id; ?>" class="btn btn-primary btn-sm me-3" >Изменить задачу</a>
												<a href="https://it-sfera.uz/Profkom/taskmanager-main/functions/delete-task.php?task_id=<?php echo $task_id; ?>" class="btn btn-danger btn-sm" >Удалить задачу</a>
											</div>
										</div>
                ...
                $conn = mysqli_connect(LOCALHOST, DB_USERNAME, DB_PASSWORD) or die(mysqli_error());
                $db_select = mysqli_select_db($conn, DB_NAME) or die(mysqli_error());
                $sql = "SELECT * FROM tbl_task WHERE sost ='pros' and list_id=$list_id_url";
                $res = mysqli_query($conn, $sql);
                if($res==true)
                {
                    $count_rows = mysqli_num_rows($res);
                ...
                $conn = mysqli_connect(LOCALHOST, DB_USERNAME, DB_PASSWORD) or die(mysqli_error());
                $db_select = mysqli_select_db($conn, DB_NAME) or die(mysqli_error());
                $sql = "SELECT * FROM tbl_task WHERE sost ='done' and list_id=$list_id_url";
                $res = mysqli_query($conn, $sql);
                if($res==true)
                {
                    $count_rows = mysqli_num_rows($res);
		...
		<div class="modal fade" id="modalAddTask" tabindex="-1" aria-modal="true" role="dialog" style="display: none;">
			<div class="modal-dialog modal-lg">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						<form action="" method="POST">
							<div>
								...
								<input name="task_name" type="text" class="form-control mt-4">
							</div>
							<div class="mt-4">
							...
							<div class="d-flex mt-4">
								...
								<button class="btn btn-success" data-bs-dismiss="modal" name="submit_task">Добавить</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="modal fade" id="modalAddnap" tabindex="-1" aria-modal="true" role="dialog" style="display: none;">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header pb-0 border-0 justify-content-end">
						<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal" aria-label="Close">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						<form action="" method="POST">
							<div>
								<label for="">Название направление</label>
								<input type="text" name="list_name" class="form-control mt-4">
							</div>
							<div class="d-flex mt-4">
								<button class="btn btn-secondary me-4" type="reset">Очистить</button>
								<button class="btn btn-success" data-bs-dismiss="modal" name="submit_list">Добавить</button>
							</div>
						</form>
					</div>
				</div>
...
<?php 
        ...
        $listname = mysqli_real_escape_string($conn, $_POST['list_name']);
        $query = mysqli_query($conn, "INSERT INTO tbl_lists(`list_name`) VALUES ('$listname')");
